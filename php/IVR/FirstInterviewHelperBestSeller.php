...
[
    ["type" => 'audio', 'data' => "hello1", 'text' => "hello"],
            ...
            '1' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ...
                    ["type" => 'audio', 'data' => "bot1bestseller", 'text' => "Hey, Hi this is shreyasi from bestseller india. Are you looking for job change?"],
                ]
            ],
            ...
            [
                //["type" => 'text', 'data' => "Hi $this->first_name."],
                //["type" => 'audio', 'data' => "fi_1_1", 'text' => "I am a robot and my name is Shreyasi, I called you to check, If you are looking for a job change. can you please allow me 3 minutes?"],
                ["type" => 'audio', 'data' => "iamunabletolistenbestseller", 'text' => "Please speak loudly"],
            ]
        ],
        '111' => ['timeout' => 4, 'silence' => 2.5, 'question' =>
        [
  ...
  '112' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
[
...
'113' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
[
...
,
        '111.1' => ['timeout' => 4, 'silence' => 2.5, 'question' =>
        [
            ["type" => 'audio_s', 'data' => "bot1bestseller", 'text' => "Yes i am listening to you."],
                ["type" => 'audio_s', 'data' => "bot1bestseller", 'text' => "Please let me know , Are you looking for job change?"],
        ]
    ...
    ["type" => 'audio_s', 'data' => "bot1bestseller", 'text' => "$this->joblocation"],
        ["type" => 'audio_s', 'data' => "bot1bestseller", 'text' => "is this fine?"],
            ...
            '2' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => "audio", "data" => 'bot2bestseller', 'text' => "alright, Now robot will collect desired informatoin from you. Is this fine?"],
        ...
        ["type" => "text", "data" => "My name is Shreyasi."]
            ...
            '8' => ['timeout' => 5, 'silence' => 4, 'question' =>
                [
    ...
    private function process_normal($call, $data, $questionid, $is_disconnect, $is_Dtmf, $msg) {
     ...
     if($this->is_hangupscript){
       ...
       // $is_hello=false;
        ...
        if ($questionid!='8' && $questionid!='9' && $questionid!='10.1' && $questionid!='2e' && $questionid!='10' &&('location' == $data ||   str_contains($data, 'location')||(str_contains($data, 'where') && str_contains($data, 'opening')  )) ){
        ...
        if (
            $questionid!='8' && $questionid!='9' && $questionid!='10.1' && $questionid!='2e' && $questionid!='10' &&(
            'company' == $data || 'from' == $data  ||  str_contains($data, 'organization')||  str_contains($data, 'company') ||str_contains($data, 'organization') ||
        (
        ...
        if(str_contains($data, 'yes') ||str_contains($data, 'yeah') ||str_contains($data, 'no') ||str_contains($data, 'not')){
            $is_company=false;
        }
        if ($questionid!='8' && $questionid!='9' && $questionid!='10.1' && $questionid!='10.2' &&  $questionid!='2e' && $questionid!='10' &&('name' == $data || (str_contains($data, 'name') && $questionid!='10' &&(!str_contains($data, 'company') || substr_count($data, 'name')>1) ||  (str_contains($data, 'your')&& str_contains($data, 'name') )  ))) {
        ...
        if ($questionid!='8' && $questionid!='9' && $questionid!='10.1' && $questionid!='10.2' && $questionid!='2e' && $questionid!='10' &&('client' == $data ||  str_contains($data, 'client'))) {
        ...
        //if ( $questionid!='1' ||true ) {
            ...
            if($is_opportunity || $is_location|| $is_company||$is_share_jd||$is_job_title||$is_name||$is_connection_error){
