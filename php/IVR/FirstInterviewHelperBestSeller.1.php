    ...
    ["type" => 'audio_s', 'data' => "bot1bestseller", 'text' => "$this->joblocation"],
        ["type" => 'audio_s', 'data' => "bot1bestseller", 'text' => "is this fine?"],
            ...
            '2' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => "audio", "data" => 'bot2bestseller', 'text' => ""],
    ...
    private function process_normal($call, $data, $questionid, $is_disconnect, $is_Dtmf, $msg) {
     ...
     if($this->is_hangupscript){
       ...
       // $is_hello=false;
        ...
        $msglist=[];
        if ($questionid!='8' && $questionid!='9' && $questionid!='10.1' && $questionid!='2e' && $questionid!='10' &&('location' == $data ||   str_contains($data, 'location')) ){
        ...
        if (
            ...
            'company' == $data || 'from' == $data  ||  str_contains($data, 'company') ||str_contains($data, 'organization') ||
        (
