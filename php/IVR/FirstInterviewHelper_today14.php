    ...
    private function process_normal($call, $data, $questionid, $is_disconnect, $is_Dtmf, $msg) {
     ...
     if($this->is_hangupscript){
       ...
       // $is_hello=false;
        ...
        if ($questionid!="1" && $questionid!="2" && $questionid!="2.1" && $questionid!="111" && $questionid!="111.1" && ('hello' == $data ||   str_contains($data, 'hello')
        ...
        //if ( $questionid!='1' ||true ) {
            ...
            if( $is_opportunity ||$is_location|| $is_company||$is_share_jd||$is_job_title||$is_name||$is_connection_error||$is_hello){
