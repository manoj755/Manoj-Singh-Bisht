...
//        'beloudclear' => 'Please be loud and clear',
    ...
    function __construct() {
        ...
        $this->question_work_flow = [
            ...
            '111' => [
                ...
                ['answer' => ['profile'], 'next' => '113', 'collect_data' => false],
                ['answer' => ['location'], 'next' => '114', 'collect_data' => false],
                ['answer' => ['yes', 'ya', 'yeah', 'ok','sure','alright','go ahead','you start'
            ...
            '2' => [
               ...
               ['answer' => ['sure','ha','ok','yes', 'ya','yaa',  'han', 'yeah','alright', 'fine'], 'next' => '2.1', 'collect_data' => false],
               ['answer' => ['not interested', 'no', 'not looking', 'not', 'recently changed'], 'next' => '16', 'collect_data' => false
               ,'data_field'=>array(
    ...
    public function setdata($data=array(), $call=null) {
        ...
        $this->questions = [
            ...
            'allquestion' => ['timeout' => 5, 'silence' => 1.5, 'question' => [
                ["type" => "text", "data" => "hello are you looking for job change"],
                ["type" => "text", "data" => "Now the bot will connect with you"],
                ["type" => "text", "data" => "Hello Narender I have a job for role of Tech Lead 
                (Backend) the company name is Cue Learn Pvt Ltd,the compa
                ny is in Bangalore Is it fine"],
                ["type" => "text", "data" => "Before we go ahead i will tell you breif about company CUE Math 
                is a young educational-technology start-up in the domain of mathematics education. CUE MATH is 
                backed up by world class Investors Is it fine"],

                ["type" => "text", "data" => "Now i would like to check your fitment for this role please tell me what is your current ctc"],
                ["type" => "text", "data" => "And what is your excpected ctc"],
                ["type" => "text", "data" => "What is your notice period"],
                ["type" => "text", "data" => "Now you have to rate on certain technical skill Is it fine"],
                ["type" => "text", "data" => "how much would you rate yourself in Python"],
                ["type" => "text", "data" => "and what about in Javascript"],
                ["type" => "text", "data" => "and in Full stack Development"],
                ["type" => "text", "data" => "what is your overall Experience"],
                ["type" => "text", "data" => "Have you ever applied for the company Cue Learn Pvt Ltdin past 6 months via any other sources"],
                ["type" => "text", "data" => "Thanks for showing interest, our team will review your applications 
                and share furthur interview process,Please note that we only conduct interviews on weekdays is it fine"],

                ["type" => "text", "data" => "Alright,Narender I shall check in job pipeline and keep you posted,
                There is good news,After this call you will Receive a link in your email and sms, where you can 
                login to PassiveReferral dot com and Refer friends from your network.On every successful joining 
                you will get exciting Referral bonus. bye.Have a great day ahead. bye and goodbye"],

                ["type" => "text", "data" => "What was that"],
                ["type" => "text", "data" => "sorry i didn't get that"],
                ["type" => "text", "data" => "yes i can hear you"],
                ["type" => "text", "data" => " i will speak loud"],
                ["type" => "text", "data" => "alright i will repeat"],
            ...
            'didnotgetanyinput' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => 'audio_s', 'data' => "helloanswer", 'text' => "I didn't get any input. Please speak again"],
                ]
            ],
            'and' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
            [
                ["type" => 'audio_s', 'data' => "helloanswer", 'text' => "and"],
            ]
        ],
        'connection_error' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
            [
...
[
    ["type" => 'audio', 'data' => "hello1", 'text' => "hello"],
            ...
            'beloudandclear' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
            ...
            'beloudandclearwithrepeat' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => 'audio_s', 'data' => "beloudandclear", 'text' => "I am unable to understand your input."],
                    ["type" => 'audio_s', 'data' => "beloudandclear", 'text' => "Please speak loud and clear."],                    
                    ["type" => 'audio_s', 'data' => "d", 'text' => "Hey "],
            ...
            '1' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ...
                    ["type" => 'audio', 'data' => "bot1", 'text' => "Hey, Hi this is shreyasi from passivereferral.com. Are you looking for job change?"],
                ]
            ],
            '1.1' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
            [
                //["type" => 'text', 'data' => "Hi $this->first_name."],
                //["type" => 'audio', 'data' => "fi_1_1", 'text' => "I am a robot and my name is Shreyasi, I called you to check, If you are looking for a job change. can you please allow me 3 minutes?"],
                ["type" => 'audio', 'data' => "iamunabletolisten", 'text' => "can you please speak loudly"],
            ]
        ],
        '111' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
        [
  ...
  '112' => ['timeout' => 5, 'silence' => 2, 'question' =>
[
...
'113' => ['timeout' => 4, 'silence' => 1.5, 'question' =>
[
...
'114' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
[
...
,
        '111.1' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
        [
            ["type" => 'audio_s', 'data' => "bot1", 'text' => "Yes i am listening to you."],
                ["type" => 'audio_s', 'data' => "bot1", 'text' => "Please let me know , Are you looking for job change?"],
        ]
  ...
  '112.1' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
[
    ["type" => 'audio_s', 'data' => "bot1", 'text' => "name of the company is "],
    ["type" => 'audio_s', 'data' => "bot1", 'text' => "$this->clientname"],
    ["type" => 'audio_s', 'data' => "bot1", 'text' => "is this fine?"],
...
'113.1' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
[
    ["type" => 'audio_s', 'data' => "bot1", 'text' => "profile is "],
    ["type" => 'audio_s', 'data' => "bot1", 'text' => "$this->jobtitle"],
    ["type" => 'audio_s', 'data' => "bot1", 'text' => "is this fine?"],
...
'114.1' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
[
    ["type" => 'audio_s', 'data' => "bot1", 'text' => "job location is "],
    ["type" => 'audio_s', 'data' => "bot1", 'text' => "$this->joblocation"],
        ["type" => 'audio_s', 'data' => "bot1", 'text' => "is this fine?"],
            ...
            '2' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => "audio", "data" => 'bot2pr', 'text' => "alright, Now robot will collect desired informatoin from you. Is this fine?"],
                  
                ]
            ],
            '2.1' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
            [
        ...
        'opportunity' => ['timeout' => 5, 'silence' => 1.5, 'question' => [
            ["type" => 'audio_s', 'data' => 'fi_2_1', 'text' => "I have a job for the role of , "],
            ["type" => 'audio_s', 'data' => 'fi_2_1', 'text' => "$this->jobtitle"],
            ["type" => 'audio_s', 'data' => 'fi_2_1', 'text' => "at"],
            ["type" => 'audio_s', 'data' => 'fi_2_1', 'text' => "$this->clientname"],
            ...
            '2a' => ['timeout' => 5, 'silence' => 1.5, 'question' => [
                    ["type" => "text", "data" => "job location is "],
                    ["type" => "text", "data" => "$this->joblocation"]
                ]
            ],
            'hello' => ['timeout' => 5, 'silence' => 1.5, 'question' => [
                ["type" => "text", "data" => "yes, I am listening to you. if you want me to repeat, please say repeat"],                
            ]
        ],
            '2b' => ['timeout' => 5, 'silence' => 1.5, 'question' => [
                    ["type" => "text", "data" => "i am hiring for "],
                    ["type" => "text", "data" => "$this->clientname"]
                ]
            ],
            '2c' => ['timeout' => 5, 'silence' => 1.5, 'question' => [
                ["type" => "text", "data" => "i am hiring for "],
                ["type" => "text", "data" => "$this->clientname"]
            ]
        ],
        '2d' => ['timeout' => 5, 'silence' => 1.5, 'question' => [
            ["type" => "text", "data" => "Profile is "],
            ["type" => "text", "data" => "$this->jobtitle"]
        ]
    ], '2e' => ['timeout' => 5, 'silence' => 1.5, 'question' => [
        ["type" => "text", "data" => "My name is Shreyasi."]
    ]
],
'2f' => ['timeout' => 5, 'silence' => 1.5, 'question' => [
    ["type" => "text", "data" => "i am fine."]
]
],
            '3' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => "audio_s", "data" => 'fi_3_1', 'text' => "Please suggest me, time to callback?"]
                ]
            ],
            '4' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
            ...
            '9' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
            ...
            '10' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
            ...
            '14' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
            ...
            '15' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
            ...
            '16' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => "text", "data" => "Hey "],
            ...
            '28' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
            ...
            '17' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => "audio_s", "data" => 'fi_17_1', 'text' => "bye.. Have a great day ahead."],
                ]
            ...
            '18' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
            ...
            '20' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => "audio_s", "data" => 'fi_18_1', 'text' => "Thank you i have noted."],
            ...
            '27' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
            [
                ["type" => "audio_s", "data" => 'fi_18_1', 'text' => "Thank you i have noted."],
               // ["type" => "audio_s", "data" => 'fi_16_1', 'text' => "There is good news, After this call you will Receive a link in your email and sms, where you can login to PassiveReferral dot com and Refer friends from your network. On every successful joining you will get exciting Referral bonus."],
               ["type" => 'audio_s', 'data' => "bot3", 'text' => ", There is good news, After this call you will Receive a link in your email and sms, where you can login to PassiveReferral dot com and Refer friends from your network. On every successful joining you will get exciting Referral bonus."],
            ...
            '21' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => "audio_s", "data" => 'fi_18_1', 'text' => "Thank you i have noted."],
                    ["type" => "audio_s", "data" => 'fi_17_1', 'text' => "bye.. Have a great day ahead."],
            ...
            '22' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
                    ["type" => "text", "data" => "Hey "],
                    ["type" => "text", "data" => "$this->first_name"],
    ...
    private function process_normal($call, $data, $questionid, $is_disconnect, $is_Dtmf, $msg) {
     ...
     if($this->is_hangupscript){
       ...
       // $is_hello=false;
        ...
        if (('opportunity' == $data ||   str_contains($data, 'opportunity') ) && !str_contains($data, 'not') && !str_contains($data, 'yes') && !str_contains($data, 'no') ){
            $msglist[] = $this->questions['opportunity']['question'];
            $is_disconnect = false;
            $is_Dtmf = FALSE;
            $is_opportunity = true;
        ...
        ||(str_contains($data, 'where') && str_contains($data, 'opening')  )) {
        ...
        if (
            //$questionid!="1" && $questionid!="2" && $questionid!="2.1" && $questionid!="111" && $questionid!="111.1" && 
            ('hello' == $data ||   str_contains($data, 'hello')
        ||(str_contains($data, 'hear') &&
        str_contains($data, 'me'))
||(str_contains($data, 'am') &&
str_contains($data, 'i') && 
str_contains($data, 'audible') 
)

        )) {
            $hellotext="";
          //  $this->pagiClient->consoleLog("********$questionid************");
        // $this->pagiClient->consoleLog($data);
        $hellotext= trim(str_replace("hello"," ",$data));
        
        $this->pagiClient->consoleLog("********$hellotext************");
        if($hellotext==""      ||(str_contains($data, 'hear') &&
        str_contains($data, 'me'))
...
str_contains($data, 'audible') 
            ...
            $msglist[] = $this->questions['hello']['question'];
            $is_disconnect = false;
            $is_Dtmf = FALSE;
            $is_hello= true;
        }
        ...
        if ('company' == $data || 'from' == $data  ||  str_contains($data, 'company')||  str_contains($data, 'organization') ||
        (
        ...
        if ('name' == $data
             ||( str_contains($data, 'name') && 
                            (!str_contains($data, 'company') || substr_count($data, 'name')>1)
                        ||  (str_contains($data, 'your')&& str_contains($data, 'name') )  )

                ||( 
                    str_contains($data, 'who') &&
                    str_contains($data, 'this') 
                )
                ||( 
                    str_contains($data, 'who')
                     &&
                    str_contains($data, 'i') 
                    &&
                    str_contains($data, 'talking') 
                )
                ||( 
                    str_contains($data, 'whom')
                     &&
                    str_contains($data, 'i') 
                    &&
                    str_contains($data, 'speaking') 
                )
             ) {
        ...
        if (
            str_contains($data, 'how')&&
            str_contains($data, 'are')&&
            str_contains($data, 'you')
            ) {
            $msglist[] = $this->questions['2f']['question'];
            $is_disconnect = false;
            $is_Dtmf = FALSE;
            $is_how_are_you =false ;
        ...
        //if ( $questionid!='1' ||true ) {
            ...
            if( $is_opportunity ||$is_location|| $is_company||$is_share_jd||$is_job_title||$is_name||$is_connection_error||$is_hello||$is_how_are_you){
            if(!$is_connection_error){
                 $this->process_question($data, $questionid);
            }
            ...
            if ($answer ===  $this->nodata||$answer==false) {
                ...
                $msg = $this->questions['beloudandclearwithrepeat']['question'];
                    ...
                    //&& false
                        ...
                        $msg=$this->questions['1.1']['question'];
                    }else{
                    $msg= [
...
//var_dump($call);
    ...
    function prepare_data($text){
        $cdr = $this->pagiClient->getCDR();
        $answerlength=0;
        if($cdr !=null){
            $answerlength= $cdr->getAnswerLength();
        }
       // $this->pagiClient->consoleLog('*****************'.$text.'*********************** ');
        return array(
            'text'=>$text,
            'audio'=>$this->pagiClient->getVariable('t_u_id'),
            'confidence'=>'',
            'questionid'=>$this->pagiClient->getVariable('questionid'),
            'start_transcribe'=>$this->pagiClient->getVariable('starttranscribe'),
            'end_transcribe'=>$answerlength,
            'start_speaking'=>$this->pagiClient->getVariable('startspeaking'),
            'end_speaking'=>$this->pagiClient->getVariable('endspeaking'),
        );
    }

    public function prepare_msg($full_response){
        $fullspeech='';
    ...
    public function process_talk($all,$call,$repeatquestion=false,$is_hangup=false,$resultarr) {
        $this->is_hangupscript=$is_hangup;       
      // $this->pagiClient->consoleLog('*****************Reach Here*********************** ');
        $this->call=$call;
...
if(is_array($conversation) && count($conversation)>0){
    ...
    //$this->pagiClient->consoleLog('*****************Reach Here*********************** ');
        ...
        $conversation[$key] =$this->prepare_data($all['data']);
        $this->pagiClient->consoleLog('*****************Reach Here first*********************** ');
...
if($this->isdebug){
    var_dump($all);
        ...
        if ($all['event'] == "NewCall") {
            ...
            //$call=new Call();
            $questionid = 1;
            $msg = $this->prepare_msg($all['msg']);
            
            

            $conversation[$msg . '__' . $call->repetition] = '';
            // //dd(json_encode($conversation));
            // //dd($conversation);
             $call->conversation = json_encode($conversation);
...
//$_SESSION['dial_status']=$_REQUEST['status'];
            ...
            $conversation[$last_question . '__' . $call->repetition] = $this->prepare_data($data);
            // //dd(json_encode($conversation));
            // //dd($conversation);
             $call->conversation = json_encode($conversation);
            $call->call_status = 'disconnected';
...
//process
        ...
        if ($is_new_call&&false) {
         ...
         //   $last_question = $call->getspeechstr($call->last_question);
            ...
            //$this->pagiClient->0('last question  is ******************** '.$data.'**************');
            ...
            $conversation[$speech . '__' . $call->repetition.$questionid] = array();
            //dd(json_encode($conversation));
            //dd($conversation);
            $call->conversation = json_encode($conversation);
            $call->last_question = $speech;
...
//,$repeatquestion=false,$is_hangup=false,$resultarr

    public function save_talk($all,$call) {
       
       try{

       $this->pagiClient->consoleLog($call->id);
       if($call==null){
        $alldata= ' call is null';
       }else{
           $alldata='call is not '.gettype($call);     
       }
    $this->pagiClient->consoleLog("$alldata  #################");
      ...
      // $this->pagiClient->consoleLog('*****************Reach Here*********************** ');
        ...
        $this->pagiClient->consoleLog('$$-------------------save talk -------------------------$$$');
        //$alldata='call is not '.gettype($call->conversation);  
        $this->pagiClient->consoleLog("$call->conversation  #################");
       
//$this->pagiClient->consoleLog($conversation);
      ...
      //  $this->pagiClient->consoleLog('data check$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$');
        //$this->pagiClient->consoleLog($callid);
       // $this->pagiClient->consoleLog('data check$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$');
...
$msg = $call->last_question;
//return '';
$this->pagiClient->consoleLog($msg);
if($msg !=null && $msg!=''){ 
//$conversation[$msg . '__' . uniqid()] = $this->prepare_data($all['data']);
$conversation[$msg . '__' . uniqid().rand(1,19999999999999999999999)] = $this->prepare_data($all['data']);
// //dd(json_encode($conversation));
// //dd($conversation);
 ...
 $call->conversation = json_encode($conversation);
    ...
    //$call->last_question=$ex->getMessage().$ex->getTraceAsString();
    //$ab='{"b":1}';
    //$ab=json_decode($ab);
    $call->disconnect_data=json_encode($ex->getTrace());
}

$call->last_question=$this->prepare_msg($all['msg']);
$call->save();


    

//$this->pagiClient->setVariable('lastquestion',$this->prepare_msg($all['msg']));
