...
[
    ...
    ["type" => 'audio_s', 'data' => "bot1bestseller", 'text' => "$this->joblocation"],
        ...
        //'question' => "Now lets get little technical, Rate yourself out of 10 in $this->primaryskill1"
            ...
            '10.1' => ['timeout' => 5, 'silence' => 1.5, 'question' =>
                [
    ...
    private function process_normal($call, $data, $questionid, $is_disconnect, $is_Dtmf, $msg) {
     ...
     if($this->is_hangupscript){
       ...
       // $is_hello=false;
        ...
        if (
            $questionid!='8' &&(
            'company' == $data || 'from' == $data  ||  str_contains($data, 'company') ||
        (
        ...
        if ($questionid!='8' && ('name' == $data || (str_contains($data, 'name') && (!str_contains($data, 'company') || substr_count($data, 'name')>1) ||  (str_contains($data, 'your')&& str_contains($data, 'name') )  ))) {
