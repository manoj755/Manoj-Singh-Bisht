...
export class SmslogComponent implements OnInit {
  ...
  LoadData(): void {
    this.db.list('smslog/', {}, ((response): void => {
  ...
  onActionEditClick(row): void {
    ...
    this.isEdit = false;
    this.db.show('smslog/', row.id, ((response): void => {
  ...
  smslogupdate(): void {
    this.db.update('smslog/', this.smslog.id, this.smslog, ((response): void => {
  ...
  smslogsave(): void {
    ...
    this.db.store('smslog/', this.smslog, ((response): void => {
