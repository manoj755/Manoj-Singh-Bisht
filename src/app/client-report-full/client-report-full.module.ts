...
import { ClientReportFullRoutes } from './client-report-full.routes';
...
@NgModule({
  ...
  imports: [
    RouterModule.forChild(ClientReportFullRoutes), CommonModule, FormsModule, ReportscomponentsModule,
  ...
  exports: [ClientReportFullComponent],
  schemas: [CUSTOM_ELEMENTS_SCHEMA]
})
export class ClientReportFullModule {
