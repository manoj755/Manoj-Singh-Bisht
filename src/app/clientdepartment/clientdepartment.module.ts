...
import { ClientdepartmentComponent } from 'app/clientdepartment/clientdepartment.component';
import { ClientdepartmentRoutes } from './clientdepartment.routes';
...
@NgModule({
  ...
  imports: [
    RouterModule.forChild(ClientdepartmentRoutes), CommonModule, FormsModule, ReportscomponentsModule,
  ...
  exports: [ClientdepartmentComponent],
