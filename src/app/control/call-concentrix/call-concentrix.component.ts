...
declare var $: any;
@Component({
  selector: 'app-call-concentrix',
  templateUrl: './call-concentrix.component.html',
  styleUrls: ['./call-concentrix.component.scss']
})
export class CallConcentrixComponent implements OnInit {
  @Input()
  allids = [];
  clients = [];
  departments = [];
