...
declare var $: any;
@Component({
  selector: 'app-candidate-campaign-view',
  templateUrl: './candidate-campaign-view.component.html',
  styleUrls: ['./candidate-campaign-view.component.scss']
})
export class CandidateCampaignViewComponent implements ICellRendererAngularComp {
  private params: any;
